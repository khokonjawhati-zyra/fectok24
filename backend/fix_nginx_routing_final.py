...
def update_nginx():
    ...
    # Master Nginx Config with Error Pass-Through
    NGINX_CONF = f"""
user  nginx;
...
http {{
    ...
    server {{
        ...
        # V15 AUTHENTICATION TUNNELS [ENHANCED ERROR PASS-THROUGH]
...
"""
    ...
    ssh.close()
    print("✅ DEPLOYMENT PROTOCOL SUCCESSFUL: Nginx error pass-through active.")
